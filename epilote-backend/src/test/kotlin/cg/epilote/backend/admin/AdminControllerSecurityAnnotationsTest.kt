...
class AdminControllerSecurityAnnotationsTest {
    ...
    fun `monetization endpoints require super admin role`() {
        ...
        assertPreAuthorize("listSubscriptions", "hasRole('SUPER_ADMIN')", java.lang.Integer::class.java, java.lang.Integer::class.java)
        ...
        assertPreAuthorize("listPaymentReceipts", "hasRole('SUPER_ADMIN')", java.lang.Integer::class.java, java.lang.Integer::class.java)
        assertPreAuthorize("listGroupePaymentReceipts", "hasRole('SUPER_ADMIN')", String::class.java, java.lang.Integer::class.java, java.lang.Integer::class.java)
    }

    private fun assertPreAuthorize(methodName: String, expected: String, vararg parameterTypes: Class<*>) {
        val method = AdminMonetisationController::class.java.getDeclaredMethod(methodName, *parameterTypes)
